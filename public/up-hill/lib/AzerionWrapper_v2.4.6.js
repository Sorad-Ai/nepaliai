/*! For license information please see AzerionWrapper_v2.4.6.js.LICENSE.txt */
(() => {
    "use strict";
    var __webpack_modules__ = {
            2690: (e, t) => {
                ...
                var n = function() {
                    ...
                    return e.prototype.isValidType = function(e) {
                        return "string" == typeof e
                    }, e.prototype.isValidHandler = function(e) {
                        ...
                        return n || (n = this._eventHandlers[e] = []), !(n.indexOf(t) >= 0) && (t._once = !1, n.push(t), !0)
                    }, e.prototype.once = function(e, t) {
                        if (!e || !t) return !1;
                        if (!this.isValidType(e)) return !1;
                        if (!this.isValidHandler(t)) return !1;
                        var n = this.on(e, t);
                        return n && (t._once = !0), n
                        ...
                        if (e && this.isValidType(e)) {
                            var n = this._eventHandlers[e];
                            if (n && n.length)
                                for (var a = this.createEvent(e, t), r = 0, i = n; r < i.length; r++) {
                                    var s = i[r];
                                    this.isValidHandler(s) && (s._once && (a.once = !0), s(a), a.once && this.off(e, s))
                                }
                        }
                    }, e.prototype.has = function(e, t) {
                        if (!e || !this.isValidType(e)) return !1;
                        var n = this._eventHandlers[e];
                        return !(!n || !n.length) && (!t || !this.isValidHandler(t) || n.indexOf(t) >= 0)
                    }, e.prototype.getHandlers = function(e) {
                        return e && this.isValidType(e) && this._eventHandlers[e] || []
                    }, e.prototype.createEvent = function(e, t, n) {
                        return void 0 === n && (n = !1), {
                            type: e,
                            data: t,
                            timestamp: Date.now(),
                ...
                t.EventEmitter = n, t.globalEvent = new n
            },
            5215: (e, t) => {
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.nulOrUnd = void 0, t.nulOrUnd = function(e) {
                    return null == e
                }
            },
            8744: function(e, t, n) {
                ...
                class E extends r.EventEmitter {
                    constructor() {
                        super(), this.isReady = !1, this.gameStarted = !1, this.interface = new r.EventEmitter, s.default.setupUIStyle()
                    }
                    static get instance() {
                        return void 0 === E._instance ? E._instance = new E : E._instance
                    }
                    static isPlatformSupported() {
                        return E.commsManager.isPlatformSupported
                    }
                    getPlayerID() {
                        return E.commsManager.playerID
                    }
                    async init(e) {
                        ...
                        return E.commsManager.checkPlatformSupport(t), await this.storageManager.initialize(this.config), this.createInterface(e.interface), await this.initAds(), this.config.inAppPurchase && await this.initIAP(), window.sgWrapper = this, this.createUI(e), this.initOnceAllReady(), Promise.resolve()
                    }
                    initOnceAllReady() {
                        let e = !1;
                        const t = () => {
                            e || (e = !0, window.onWrapperReady && window.onWrapperReady(), this.fire(l.default.READY), this.isReady = !0)
                        };
                    ...
                    async onStartGame() {
                        this.gameStarted = !0, this.fire(l.default.GAME_START);
                        const {
                            err: e
                    ...
                    static get placementIDs() {
                        return E.instance.placementIDs
                    }
                    static get commsManager() {
                        return E.instance.commsManager
                    }
                    static get adManager() {
                        return E.instance.adManager
                    }
                    static get iapManager() {
                        return E.instance.iapManager
                    }
                    static get interface() {
                        return E.instance.interface
                    }
                    static get config() {
                        return E.instance.config
                    }
                    static get storageManager() {
                        return E.instance.storageManager
                    }
                    static get leaderboards() {
                        return E.instance.leaderboards
                    }
                    static get sdkHandler() {
                        return E.instance.sdkHandler
                    }
                    static set sdkHandler(e) {
                        E.instance.sdkHandler = e
                    }
                }
                t.default = E
            },
            ...
            2673: function(e, t, n) {
                ...
                class u extends s.default {
                    constructor(e) {
                        super(e), this.player = new d.default, this.payments = new l.default, this.tournament = new c.default, this.context = new o.default, window.FBInstant = this
                    }
                    initializeAsync() {
                        return i.default.instance.supportedLanguages = ["en"], Promise.resolve()
                    }
                    startGameAsync() {
                        return this.interfaceRef.fire(r.InterfaceEvent.LOAD_PROGRESS, {
                            progress: 101
                        }), i.default.commsManager.startGame(), Promise.resolve()
                    }
                    setLoadingProgress(e) {
                        const t = e || 0;
                        i.default.commsManager.setLoadingProgress(t), e >= 100 && this.interfaceRef.fire(r.InterfaceEvent.LOADED)
                    }
                    onPause(e) {}
                    getLocale() {
                    ...
                    async getRewardedVideoAsync(e) {
                        return Promise.resolve({
                            ...
                            showAsync: () => new Promise((async (e, t) => {
                                const n = await i.default.adManager.showRewardedAd();
                                n ? e(n) : t()
                            })),
                    ...
                    async getLeaderboardAsync(e) {
                        return new Promise((async e => {
                            e(await window.sgLeaderboards.getHandler(i.default.config))
                        }))
                    }
            ...
            2596: function(e, t, n) {
                ...
                t.default = class {
                    ...
                    onReady(e) {
                        if (i.default.iapManager.ready) return e && e();
                        i.default.iapManager.once(r.IAPEvents.IAP_READY, (() => {
                            e && e()
                        }))
                    }
                    hasIAPSupport() {
            ...
            694: function(e, t, n) {
                ...
                class c extends o.default {
                    ...
                    finished(e) {
                        return this.interfaceRef.fire(i.InterfaceEvent.LOADED), this.interfaceRef.fire(i.InterfaceEvent.LOAD_PROGRESS, {
                            progress: 101
                        }), Promise.resolve()
                    }
                    ...
                    gameStart() {
                        this.interfaceRef.fire(r.GameEvent.GAME_START)
                    }
                    gameOver(e, t) {
                        this.interfaceRef.fire(r.GameEvent.GAME_OVER, {
                            level: e,
                            score: t
                        }), this.trackScore(e, t)
                    }
                    ...
                    async trigger(e, t) {
                        switch (e) {
                            ...
                            case d.SGSDKTriggers.LOADING_UPDATE:
                                ...
                                }), t.progressPercentage >= 100 && this.interfaceRef.fire(i.InterfaceEvent.LOADED);
                                break;
                            ...
                            case d.SGSDKTriggers.LEVEL_START:
                                if (this.interfaceRef.fire(r.GameEvent.LEVEL_START, {
                                        level: t.level
                                    }), t.callback) return void t.callback();
                                break;
                            case d.SGSDKTriggers.LEVEL_FINISH:
                                if (this.interfaceRef.fire(r.GameEvent.LEVEL_FINISH, {
                                        level: t.level
                            ...
                            case d.SGSDKTriggers.GAME_OVER:
                                if (this.interfaceRef.fire(r.GameEvent.GAME_OVER, t), this.trackScore(null, t.score), t.callback) return void t.callback();
                                break;
            ...
            1547: function(e, t, n) {
                ...
                t.default = class {
                    ...
                    setAdClosedCallback(e) {
                        s.default.adManager.on(r.AdManagerEvent.AD_CLOSE, (() => {
                            e && e()
                        }))
                    }
                    ...
                    isIAP() {
                        return s.default.instance.iapManager.hasIAPSupport()
                    }
                    isMobile() {
                        return [/Android/i, /webOS/i, /iPhone/i, /iPad/i, /iPod/i, /BlackBerry/i, /Windows Phone/i].some((e => navigator.userAgent.match(e)))
                    }
                    showSupportPopup() {
                        s.default.instance.showSupportPopup()
                    }
                    trackScore(e, t) {
                        (0, i.nulOrUnd)(e) ? (0, i.nulOrUnd)(t) || s.default.commsManager.setScore(t): s.default.commsManager.setScore(e)
                    }
                    setIAPGiftCallback(e) {
                        s.default.instance.iapTracker.giftManager.setIAPGiftCallback(e)
                    }
                    clearUserData() {
                        s.default.instance.storageManager.clearAllData()
                    }
                }
            },
            5499: (e, t) => {
            ...
            5207: function(e, t, n) {
                ...
                class f extends s.default {
                    async initialize() {
                        super.initialize(), l.default.i.on(u.AzerionMetaEvents.CONTENT_PAUSE_REQUESTED, (() => {
                            this.fire(r.AdManagerEvent.AD_START)
                        }));
                        const e = [c.AzerionEvent.SDK_COMPLETE, c.AzerionEvent.SDK_SKIPPED, c.AzerionEvent.SDK_GAME_START, c.AzerionEvent.SDK_ERROR, c.AzerionEvent.AD_IS_ALREADY_RUNNING];
                        for (let t in e) l.default.i.on(e[t], (() => {
                            this.fire(r.AdManagerEvent.AD_CLOSE)
                        }));
                    ...
                    async showInterstitialAd() {
                        this.fire(r.AdManagerEvent.AD_REQUESTED), this.adTimer.ready && (super.showInterstitialAd(), i.default.sdkHandler.showAd())
                    }
                    async showRewardedAd() {
                        super.showRewardedAd(), this.fire(r.AdManagerEvent.AD_REQUESTED);
                        const e = new Promise((async (e, t) => {
                            const n = () => {
                                    s(), e(!0), this.fire(r.AdManagerEvent.AD_COMPLETE), this.fire(r.AdManagerEvent.AD_CLOSE)
                                },
                                a = () => {
                                    s(), e(!1), this.fire(r.AdManagerEvent.AD_SKIP), this.fire(r.AdManagerEvent.AD_CLOSE)
                                },
                                s = () => {
                                    l.default.i.off(c.AzerionEvent.SDK_COMPLETE, n), l.default.i.off(c.AzerionEvent.SDK_REWARDED_WATCH_COMPLETE, n), l.default.i.off(c.AzerionEvent.SDK_SKIPPED, a), l.default.i.off(c.AzerionEvent.SDK_ERROR, a)
                                };
                            l.default.i.on(c.AzerionEvent.SDK_COMPLETE, n), l.default.i.on(c.AzerionEvent.SDK_REWARDED_WATCH_COMPLETE, n), l.default.i.on(c.AzerionEvent.SDK_SKIPPED, a), l.default.i.on(c.AzerionEvent.SDK_ERROR, a), i.default.sdkHandler.showAd(d.AzerionAdType.REWARDED).then((e => {})).catch((t => {
                                this.adTimer.freeRewardedReady, e(!1), this.fire(r.AdManagerEvent.AD_ERROR, t), this.fire(r.AdManagerEvent.AD_CLOSE)
                            }))
                        }));
                    ...
                    async preloadNextRewarded() {
                        let {
                            err: e
                        } = await i.default.sdkHandler.preloadAd(d.AzerionAdType.REWARDED);
                ...
                class u extends l.default {
                    ...
                    async initialize() {
                        window.GD_OPTIONS = {
                            ...
                            prefix: "sg_",
                            onEvent: function(e) {
                                console.log("event :: " + e.name), d.default.i.fire(e.name, e)
                            },
                        ...
                        const e = new Promise((async (e, t) => {
                            d.default.i.once(c.AzerionEvent.SDK_READY, (() => {
                                if (window.gdsdk) o.default.sdkHandler = window.gdsdk, e(!0);
                                else {
                                    const t = setInterval((() => {
                                        window.gdsdk && (clearInterval(t), o.default.sdkHandler = window.gdsdk, console.log(o.default.sdkHandler), e(!0))
                                    }), 10)
                                }
                            }))
                        }));
                        return function(e, t, n) {
                            ...
                            e.getElementById(n) || (a = e.createElement(t), a.id = n, a.src = "https://html5.api.gamedistribution.com/main.min.js", r.parentNode.insertBefore(a, r))
                        }(document, "script", "gamedistribution-jssdk"), d.default.i.on(c.AzerionEvent.SDK_GAME_PAUSE, (() => {
                            this.hasPaused = !0, o.default.instance.fire(i.default.GAME_PAUSE)
                        })), d.default.i.on(c.AzerionEvent.SDK_GAME_START, (() => {
                            this.hasPaused && o.default.instance.fire(i.default.GAME_RESUME), this.hasPaused = !1
                        })), e
                    }
                    async startGame() {
                        return Promise.resolve({
            ...
            9167: function(e, t, n) {
                ...
                class c extends r.EventEmitter {
                    ...
                    showInterstitialAd() {
                        ...
                        })), this.adTimer.stopLongPlayAdTimer(), this.fire(i.AdManagerEvent.INTERSTITIAL_AD_REQUESTED))
                    }
                    showRewardedAd() {
                        d.default.config.options && !0 === d.default.config.options.disableAllAds || this.fire(i.AdManagerEvent.REWARDED_AD_REQUESTED)
                    }
                    setupTimer() {
                ...
                class c extends r.EventEmitter {
                    ...
                    startLongPlayAdTimer() {
                        !this.isLongPlayTimerRunning && this.isGameOrLevelPlaying && (console.log("LONG PLAY TIMER STARTED"), this.isLongPlayTimerRunning = !0, this.longPlayTimerID && window.clearInterval(this.longPlayTimerID), this._longPlayTimeLeft = i.default.config.adsConfig.longGameplayCooldownMS, this.longPlayTimerID = window.setInterval((() => {
                            this._longPlayTimeLeft -= 1e3, this.fire(l.AdTimerEvent.LONGPLAY_TICK), this.longPlayTimeLeft <= 0 ? (window.clearInterval(this.longPlayTimerID), this.onLongPlayTimerEnd()) : this._longPlayTimeLeft <= this.adRules.adWarningDuration && (this._longPlayTimeLeft == this.adRules.adWarningDuration && this.fire(l.AdTimerEvent.LONGPLAY_WARN), console.log("warning :: " + this._longPlayTimeLeft), this.fire(l.AdTimerEvent.LONGPLAY_WARN_TICK))
                        }), 1e3), this.fire(l.AdTimerEvent.LONGPLAY_TICKER_START))
                    }
                    stopLongPlayAdTimer() {
                        console.log("LONG PLAY TIMER STOPPED"), window.clearTimeout(this.longPlayTimerID), this.isLongPlayTimerRunning = !1, this.fire(l.AdTimerEvent.LONGPLAY_TICKER_STOP)
                    }
                    startAdCoolDownTimer() {
                        ...
                        }), this.adRules.adCooldownDuration), this.fire(l.AdTimerEvent.COOLDOWN_START)
                    }
                    stopAdCoolDownTimer() {
                    ...
                    onAdCoolDownTimerEnd() {
                        this._ready = !0, this.fire(l.AdTimerEvent.COOLDOWN_END)
                    }
                    onLongPlayTimerEnd() {
                        this._longPlayTimeLeft = -1, i.default.adManager.once(o.AdManagerEvent.AD_CLOSE, (() => {
                            i.default.config.adsConfig.enableLongGameplayAds && (this.isLongPlayTimerRunning = !1, this.startLongPlayAdTimer())
                        })), this.fire(l.AdTimerEvent.LONGPLAY_TRIGGER), console.log("LONG PLAY AD TRIGERRED"), this.isLongPlayTimerRunning = !1
                    }
                }
                t.default = c
            },
            ...
            247: (e, t, n) => {
                ...
                t.default = class {
                    ...
                    async initialize(e) {
                        ...
                        this.storageKey = (0, a.v5)(`${t}_STORAGE`, "28c78f71-1c31-4331-a9ca-e51e9221b3fa");
                        const n = this.getLocalData(this.storageKey),
                            r = await this.getCloudData(this.storageKey);
                        this.store = r || n, console.log(`user data loaded from '${r?"cloudStorage":"localStorage"}'.`), console.log(`data: ${JSON.stringify(this.store)}`)
                    }
                    setItem(e, t) {
                        const n = Date.now();
            ...
            9233: (e, t, n) => {
                ...
                const _ = function(e, t, n) {
                    ...
                    var d = void 0 !== e.msecs ? e.msecs : Date.now(),
                        _ = void 0 !== e.nsecs ? e.nsecs : p + 1,
                        h = d - g + (_ - p) / 1e4;
                    if (h < 0 && void 0 === e.clockseq && (o = o + 1 & 16383), (h < 0 || d > g) && void 0 === e.nsecs && (_ = 0), _ >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
                    g = d, p = _, f = o;
                    var E = (1e4 * (268435455 & (d += 122192928e5)) + _) % 4294967296;
                    r[a++] = E >>> 24 & 255, r[a++] = E >>> 16 & 255, r[a++] = E >>> 8 & 255, r[a++] = 255 & E;
                    var A = d / 4294967296 * 1e4 & 268435455;
                    r[a++] = A >>> 8 & 255, r[a++] = 255 & A, r[a++] = A >>> 24 & 15 | 16, r[a++] = A >>> 16 & 255, r[a++] = o >>> 8 | 128, r[a++] = 255 & o;
                    for (var m = 0; m < 6; ++m) r[a + m] = s[m];
                    return t || c(r)
                };
                const h = function(e) {
                ...
                function E(e, t, n) {
                    function a(e, a, r, i) {
                        if ("string" == typeof e && (e = function(e) {
                                ...
                                return t
                            }(e)), "string" == typeof a && (a = h(a)), 16 !== a.length) throw TypeError("Namespace must be array-like (16 iterable integer values, 0-255)");
                ...
                function S(e, t, n, a, r, i) {
                    return m((s = m(m(t, e), m(a, i))) << (o = r) | s >>> 32 - o, n);
                    var s, o
                }

                function v(e, t, n, a, r, i, s) {
                    return S(t & n | ~t & a, e, t, r, i, s)
                }

                function T(e, t, n, a, r, i, s) {
                    return S(t & a | n & ~a, e, t, r, i, s)
                }

                function y(e, t, n, a, r, i, s) {
                    return S(t ^ n ^ a, e, t, r, i, s)
                }

                function P(e, t, n, a, r, i, s) {
                    return S(n ^ (t | ~a), e, t, r, i, s)
                }
                const R = function(e) {
                    if ("string" == typeof e) {
                ...
                const L = function(e) {
                    ...
                    for (var u = 0; u < s; ++u) {
                        ...
                        for (var _ = n[0], h = n[1], E = n[2], A = n[3], m = n[4], S = 0; S < 80; ++S) {
                            var v = Math.floor(S / 20),
                                T = b(_, 5) + I(v, h, E, A) + m + t[v] + f[S] >>> 0;
                            m = A, A = E, E = b(h, 30) >>> 0, h = _, _ = T
                        }
                        n[0] = n[0] + _ >>> 0, n[1] = n[1] + h >>> 0, n[2] = n[2] + E >>> 0, n[3] = n[3] + A >>> 0, n[4] = n[4] + m >>> 0
                    }
